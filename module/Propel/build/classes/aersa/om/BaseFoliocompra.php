...
/**
 * Base class that represents a row from the 'foliocompra' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseFoliocompra extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'FoliocompraPeer';
    ...
    /**
     * The value for the idfoliocompra field.
     * @var        int
     */
    protected $idfoliocompra;
    ...
    /**
     * Get the [idfoliocompra] column value.
     *
     * @return int
     */
    public function getIdfoliocompra()
    {

        return $this->idfoliocompra;
    }
    ...
    /**
     * Set the value of [idfoliocompra] column.
     *
     * @param  int $v new value
     * @return Foliocompra The current object (for fluent API support)
     */
    public function setIdfoliocompra($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idfoliocompra !== $v) {
            $this->idfoliocompra = $v;
            $this->modifiedColumns[] = FoliocompraPeer::IDFOLIOCOMPRA;
        }
    ...
    public function setFolio($v)
    {
        ...
        if ($this->folio !== $v) {
            $this->folio = $v;
            $this->modifiedColumns[] = FoliocompraPeer::FOLIO;
        }
    ...
    public function setIdempresa($v)
    {
        ...
        if ($this->idempresa !== $v) {
            $this->idempresa = $v;
            $this->modifiedColumns[] = FoliocompraPeer::IDEMPRESA;
        }
    ...
    public function setIdsucursal($v)
    {
        ...
        if ($this->idsucursal !== $v) {
            $this->idsucursal = $v;
            $this->modifiedColumns[] = FoliocompraPeer::IDSUCURSAL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idfoliocompra = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 4; // 4 = FoliocompraPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Foliocompra object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FoliocompraPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FoliocompraQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FoliocompraPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = FoliocompraPeer::IDFOLIOCOMPRA;
        if (null !== $this->idfoliocompra) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . FoliocompraPeer::IDFOLIOCOMPRA . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(FoliocompraPeer::IDFOLIOCOMPRA)) {
            $modifiedColumns[':p' . $index++]  = '`idfoliocompra`';
        }
        if ($this->isColumnModified(FoliocompraPeer::FOLIO)) {
            $modifiedColumns[':p' . $index++]  = '`folio`';
        }
        if ($this->isColumnModified(FoliocompraPeer::IDEMPRESA)) {
            $modifiedColumns[':p' . $index++]  = '`idempresa`';
        }
        if ($this->isColumnModified(FoliocompraPeer::IDSUCURSAL)) {
            $modifiedColumns[':p' . $index++]  = '`idsucursal`';
        }

        $sql = sprintf(
            'INSERT INTO `foliocompra` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idfoliocompra`':
                        $stmt->bindValue($identifier, $this->idfoliocompra, PDO::PARAM_INT);
                        break;
                    case '`folio`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FoliocompraPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FoliocompraPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Foliocompra'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Foliocompra'][$this->getPrimaryKey()] = true;
        $keys = FoliocompraPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdfoliocompra(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdfoliocompra($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FoliocompraPeer::IDFOLIOCOMPRA)) $criteria->add(FoliocompraPeer::IDFOLIOCOMPRA, $this->idfoliocompra);
        if ($this->isColumnModified(FoliocompraPeer::FOLIO)) $criteria->add(FoliocompraPeer::FOLIO, $this->folio);
        if ($this->isColumnModified(FoliocompraPeer::IDEMPRESA)) $criteria->add(FoliocompraPeer::IDEMPRESA, $this->idempresa);
        if ($this->isColumnModified(FoliocompraPeer::IDSUCURSAL)) $criteria->add(FoliocompraPeer::IDSUCURSAL, $this->idsucursal);
    ...
    {
        $criteria = new Criteria(FoliocompraPeer::DATABASE_NAME);
        $criteria->add(FoliocompraPeer::IDFOLIOCOMPRA, $this->idfoliocompra);
    ...
    /**
     * Generic method to set the primary key (idfoliocompra column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdfoliocompra();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Foliocompra (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdfoliocompra(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Foliocompra Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FoliocompraPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FoliocompraPeer();
        }
    ...
    public function getEmpresa(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpresa === null && ($this->idempresa !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpresa->addFoliocompras($this);
             */
        }
    ...
    public function getSucursal(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSucursal === null && ($this->idsucursal !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSucursal->addFoliocompras($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FoliocompraPeer::DEFAULT_STRING_FORMAT);
    }
