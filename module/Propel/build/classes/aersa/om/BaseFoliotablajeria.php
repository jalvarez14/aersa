...
/**
 * Base class that represents a row from the 'foliotablajeria' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseFoliotablajeria extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'FoliotablajeriaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FoliotablajeriaPeer
     */
    ...
    /**
     * The value for the idfoliotablajeria field.
     * @var        int
     */
    protected $idfoliotablajeria;
    ...
    /**
     * Get the [idfoliotablajeria] column value.
     *
     * @return int
     */
    public function getIdfoliotablajeria()
    {

        return $this->idfoliotablajeria;
    }
    ...
    /**
     * Set the value of [idfoliotablajeria] column.
     *
     * @param  int $v new value
     * @return Foliotablajeria The current object (for fluent API support)
     */
    public function setIdfoliotablajeria($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idfoliotablajeria !== $v) {
            $this->idfoliotablajeria = $v;
            $this->modifiedColumns[] = FoliotablajeriaPeer::IDFOLIOTABLAJERIA;
        }


        return $this;
    } // setIdfoliotablajeria()
    ...
    public function setFolio($v)
    {
        ...
        if ($this->folio !== $v) {
            $this->folio = $v;
            $this->modifiedColumns[] = FoliotablajeriaPeer::FOLIO;
        }
    ...
    public function setIdempresa($v)
    {
        ...
        if ($this->idempresa !== $v) {
            $this->idempresa = $v;
            $this->modifiedColumns[] = FoliotablajeriaPeer::IDEMPRESA;
        }
    ...
    public function setIdsucursal($v)
    {
        ...
        if ($this->idsucursal !== $v) {
            $this->idsucursal = $v;
            $this->modifiedColumns[] = FoliotablajeriaPeer::IDSUCURSAL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idfoliotablajeria = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 4; // 4 = FoliotablajeriaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Foliotablajeria object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FoliotablajeriaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FoliotablajeriaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FoliotablajeriaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = FoliotablajeriaPeer::IDFOLIOTABLAJERIA;
        if (null !== $this->idfoliotablajeria) {
        ...
        if ($this->isColumnModified(FoliotablajeriaPeer::IDFOLIOTABLAJERIA)) {
            $modifiedColumns[':p' . $index++]  = '`idfoliotablajeria`';
        }
        if ($this->isColumnModified(FoliotablajeriaPeer::FOLIO)) {
            $modifiedColumns[':p' . $index++]  = '`folio`';
        }
        if ($this->isColumnModified(FoliotablajeriaPeer::IDEMPRESA)) {
            $modifiedColumns[':p' . $index++]  = '`idempresa`';
        }
        if ($this->isColumnModified(FoliotablajeriaPeer::IDSUCURSAL)) {
            $modifiedColumns[':p' . $index++]  = '`idsucursal`';
        }

        $sql = sprintf(
            'INSERT INTO `foliotablajeria` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idfoliotablajeria`':
                        $stmt->bindValue($identifier, $this->idfoliotablajeria, PDO::PARAM_INT);
                        break;
                    case '`folio`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FoliotablajeriaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FoliotablajeriaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdfoliotablajeria();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Foliotablajeria'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Foliotablajeria'][$this->getPrimaryKey()] = true;
        $keys = FoliotablajeriaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdfoliotablajeria(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdfoliotablajeria($value);
                break;
            case 1:
                $this->setFolio($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdfoliotablajeria($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FoliotablajeriaPeer::IDFOLIOTABLAJERIA)) $criteria->add(FoliotablajeriaPeer::IDFOLIOTABLAJERIA, $this->idfoliotablajeria);
        if ($this->isColumnModified(FoliotablajeriaPeer::FOLIO)) $criteria->add(FoliotablajeriaPeer::FOLIO, $this->folio);
        if ($this->isColumnModified(FoliotablajeriaPeer::IDEMPRESA)) $criteria->add(FoliotablajeriaPeer::IDEMPRESA, $this->idempresa);
        if ($this->isColumnModified(FoliotablajeriaPeer::IDSUCURSAL)) $criteria->add(FoliotablajeriaPeer::IDSUCURSAL, $this->idsucursal);
    ...
    {
        $criteria = new Criteria(FoliotablajeriaPeer::DATABASE_NAME);
        $criteria->add(FoliotablajeriaPeer::IDFOLIOTABLAJERIA, $this->idfoliotablajeria);
    ...
    /**
     * Generic method to set the primary key (idfoliotablajeria column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdfoliotablajeria();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Foliotablajeria (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdfoliotablajeria(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Foliotablajeria Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FoliotablajeriaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FoliotablajeriaPeer();
        }
    ...
    public function getEmpresa(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpresa === null && ($this->idempresa !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpresa->addFoliotablajerias($this);
             */
        }
    ...
    public function getSucursal(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSucursal === null && ($this->idsucursal !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSucursal->addFoliotablajerias($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FoliotablajeriaPeer::DEFAULT_STRING_FORMAT);
    }
