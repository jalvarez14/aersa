...
/**
 * Base class that represents a row from the 'compranota' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseCompranota extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CompranotaPeer';
    ...
    /**
     * The value for the idcompranota field.
     * @var        int
     */
    protected $idcompranota;
    ...
    /**
     * The value for the compranota_nota field.
     * @var        string
     */
    ...
    /**
     * Get the [idcompranota] column value.
     *
     * @return int
     */
    public function getIdcompranota()
    {

        return $this->idcompranota;
    }
    ...
    /**
     * Get the [compranota_nota] column value.
     *
     * @return string
     */
    public function getCompranotaNota()
    {
    ...
    /**
     * Set the value of [idcompranota] column.
     *
     * @param  int $v new value
     * @return Compranota The current object (for fluent API support)
     */
    public function setIdcompranota($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idcompranota !== $v) {
            $this->idcompranota = $v;
            $this->modifiedColumns[] = CompranotaPeer::IDCOMPRANOTA;
        }
    ...
    public function setIdcompra($v)
    {
        ...
        if ($this->idcompra !== $v) {
            $this->idcompra = $v;
            $this->modifiedColumns[] = CompranotaPeer::IDCOMPRA;
        }
    ...
    public function setIdusuario($v)
    {
        ...
        if ($this->idusuario !== $v) {
            $this->idusuario = $v;
            $this->modifiedColumns[] = CompranotaPeer::IDUSUARIO;
        }
    ...
    /**
     * Set the value of [compranota_nota] column.
     *
     * @param  string $v new value
     * @return Compranota The current object (for fluent API support)
     */
    public function setCompranotaNota($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->compranota_nota !== $v) {
            $this->compranota_nota = $v;
            $this->modifiedColumns[] = CompranotaPeer::COMPRANOTA_NOTA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idcompranota = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CompranotaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CompranotaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CompranotaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = CompranotaPeer::IDCOMPRANOTA;
        if (null !== $this->idcompranota) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CompranotaPeer::IDCOMPRANOTA . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CompranotaPeer::IDCOMPRANOTA)) {
            $modifiedColumns[':p' . $index++]  = '`idcompranota`';
        }
        if ($this->isColumnModified(CompranotaPeer::IDCOMPRA)) {
            $modifiedColumns[':p' . $index++]  = '`idcompra`';
        }
        if ($this->isColumnModified(CompranotaPeer::IDUSUARIO)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idcompranota`':
                        $stmt->bindValue($identifier, $this->idcompranota, PDO::PARAM_INT);
                        break;
                    case '`idcompra`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CompranotaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CompranotaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Compranota'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Compranota'][$this->getPrimaryKey()] = true;
        $keys = CompranotaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdcompranota(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdcompranota($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompranotaPeer::IDCOMPRANOTA)) $criteria->add(CompranotaPeer::IDCOMPRANOTA, $this->idcompranota);
    ...
    {
        $criteria = new Criteria(CompranotaPeer::DATABASE_NAME);
        $criteria->add(CompranotaPeer::IDCOMPRANOTA, $this->idcompranota);
    ...
    /**
     * Generic method to set the primary key (idcompranota column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdcompranota();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Compranota (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdcompranota(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Compranota Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CompranotaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CompranotaPeer();
        }
    ...
    public function getCompra(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCompra === null && ($this->idcompra !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompra->addCompranotas($this);
             */
        }
    ...
    public function getUsuario(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuario === null && ($this->idusuario !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuario->addCompranotas($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CompranotaPeer::DEFAULT_STRING_FORMAT);
    }
