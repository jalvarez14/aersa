 ...
 *
 * @method EmpresaQuery leftJoinNotificacion($relationAlias = null) Adds a LEFT JOIN clause to the query using the Notificacion relation
 * @method EmpresaQuery rightJoinNotificacion($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Notificacion relation
 * @method EmpresaQuery innerJoinNotificacion($relationAlias = null) Adds a INNER JOIN clause to the query using the Notificacion relation
 *
...
abstract class BaseEmpresaQuery extends ModelCriteria
{
    ...
    public function filterByNotificacion($notificacion, $comparison = null)
    {
        if ($notificacion instanceof Notificacion) {
            return $this
                ->addUsingAlias(EmpresaPeer::IDEMPRESA, $notificacion->getIdempresa(), $comparison);
