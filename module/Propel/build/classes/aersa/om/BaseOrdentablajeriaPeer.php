...
abstract class BaseOrdentablajeriaPeer
{
    ...
    /** the column name for the ordentablajeria_porcentajemerma field */
    const ORDENTABLAJERIA_PORCENTAJEMERMA = 'ordentablajeria.ordentablajeria_porcentajemerma';
    ...
    const NOTAAUDITOREMPRESA = 'ordentablajeria.notaauditorempresa';

    /** the column name for the notaalmacenistaempresa field */
    const NOTAALMACENISTAEMPRESA = 'ordentablajeria.notaalmacenistaempresa';

    /** the column name for the notaauditoraersa field */
    const NOTAAUDITORAERSA = 'ordentablajeria.notaauditoraersa';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idordentablajeria', 'Idempresa', 'Idsucursal', 'Idalmacenorigen', 'Idalmacendestino', 'Idusuario', 'Idauditor', 'Idproducto', 'OrdentablajeriaEsporcion', 'OrdentablajeriaNumeroporciones', 'OrdentablajeriaPesobruto', 'OrdentablajeriaPreciokilo', 'OrdentablajeriaTotalbruto', 'OrdentablajeriaPesoneto', 'OrdentablajeriaPrecioneto', 'OrdentablajeriaInyeccion', 'OrdentablajeriaMerma', 'OrdentablajeriaPorcentajemerma', 'OrdentablajeriaAprovechamiento', 'OrdentablajeriaRevisada', 'OrdentablajeriaFolio', 'OrdentablajeriaFecha', 'OrdentablajeriaFechacreacion', 'OrdentablajeriaPesoporcion', 'Notaauditorempresa', 'Notaalmacenistaempresa', 'Notaauditoraersa', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idordentablajeria', 'idempresa', 'idsucursal', 'idalmacenorigen', 'idalmacendestino', 'idusuario', 'idauditor', 'idproducto', 'ordentablajeriaEsporcion', 'ordentablajeriaNumeroporciones', 'ordentablajeriaPesobruto', 'ordentablajeriaPreciokilo', 'ordentablajeriaTotalbruto', 'ordentablajeriaPesoneto', 'ordentablajeriaPrecioneto', 'ordentablajeriaInyeccion', 'ordentablajeriaMerma', 'ordentablajeriaPorcentajemerma', 'ordentablajeriaAprovechamiento', 'ordentablajeriaRevisada', 'ordentablajeriaFolio', 'ordentablajeriaFecha', 'ordentablajeriaFechacreacion', 'ordentablajeriaPesoporcion', 'notaauditorempresa', 'notaalmacenistaempresa', 'notaauditoraersa', ),
        BasePeer::TYPE_COLNAME => array (OrdentablajeriaPeer::IDORDENTABLAJERIA, OrdentablajeriaPeer::IDEMPRESA, OrdentablajeriaPeer::IDSUCURSAL, OrdentablajeriaPeer::IDALMACENORIGEN, OrdentablajeriaPeer::IDALMACENDESTINO, OrdentablajeriaPeer::IDUSUARIO, OrdentablajeriaPeer::IDAUDITOR, OrdentablajeriaPeer::IDPRODUCTO, OrdentablajeriaPeer::ORDENTABLAJERIA_ESPORCION, OrdentablajeriaPeer::ORDENTABLAJERIA_NUMEROPORCIONES, OrdentablajeriaPeer::ORDENTABLAJERIA_PESOBRUTO, OrdentablajeriaPeer::ORDENTABLAJERIA_PRECIOKILO, OrdentablajeriaPeer::ORDENTABLAJERIA_TOTALBRUTO, OrdentablajeriaPeer::ORDENTABLAJERIA_PESONETO, OrdentablajeriaPeer::ORDENTABLAJERIA_PRECIONETO, OrdentablajeriaPeer::ORDENTABLAJERIA_INYECCION, OrdentablajeriaPeer::ORDENTABLAJERIA_MERMA, OrdentablajeriaPeer::ORDENTABLAJERIA_PORCENTAJEMERMA, OrdentablajeriaPeer::ORDENTABLAJERIA_APROVECHAMIENTO, OrdentablajeriaPeer::ORDENTABLAJERIA_REVISADA, OrdentablajeriaPeer::ORDENTABLAJERIA_FOLIO, OrdentablajeriaPeer::ORDENTABLAJERIA_FECHA, OrdentablajeriaPeer::ORDENTABLAJERIA_FECHACREACION, OrdentablajeriaPeer::ORDENTABLAJERIA_PESOPORCION, OrdentablajeriaPeer::NOTAAUDITOREMPRESA, OrdentablajeriaPeer::NOTAALMACENISTAEMPRESA, OrdentablajeriaPeer::NOTAAUDITORAERSA, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrdentablajeriaPeer::ORDENTABLAJERIA_PORCENTAJEMERMA);
            ...
            $criteria->addSelectColumn(OrdentablajeriaPeer::NOTAAUDITOREMPRESA);
            $criteria->addSelectColumn(OrdentablajeriaPeer::NOTAALMACENISTAEMPRESA);
            $criteria->addSelectColumn(OrdentablajeriaPeer::NOTAAUDITORAERSA);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.ordentablajeria_porcentajemerma');
