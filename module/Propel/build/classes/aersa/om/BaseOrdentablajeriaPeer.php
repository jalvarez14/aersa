...
abstract class BaseOrdentablajeriaPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idordentablajeria', 'Idempresa', 'Idsucursal', 'Idalmacenorigen', 'Idalmacendestino', 'Idusuario', 'Idauditor', 'Idproducto', 'OrdentablajeriaEsporcion', 'OrdentablajeriaNumeroporciones', 'OrdentablajeriaPesobruto', 'OrdentablajeriaPreciokilo', 'OrdentablajeriaTotalbruto', 'OrdentablajeriaPesoneto', 'OrdentablajeriaPrecioneto', 'OrdentablajeriaInyeccion', 'OrdentablajeriaMerma', 'OrdentablajeriaAprovechamiento', 'OrdentablajeriaRevisada', 'OrdentablajeriaFolio', 'OrdentablajeriaFecha', 'OrdentablajeriaFechacreacion', 'OrdentablajeriaPesoporcion', 'Notaauditorempresa', 'Notaalmacenistaempresa', 'Notaauditoraersa', ),
