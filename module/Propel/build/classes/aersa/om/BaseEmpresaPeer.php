...
abstract class BaseEmpresaPeer
{
    ...
    /** the column name for the empresa_habilitarrecetas field */
    const EMPRESA_HABILITARRECETAS = 'empresa.empresa_habilitarrecetas';
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(AbonoproveedorPeer::IDEMPRESA, $obj->getIdempresa());
            ...
            $criteria->add(CuentaporcobrarPeer::IDEMPRESA, $obj->getIdempresa());
            ...
            $criteria->add(FoliocompraPeer::IDEMPRESA, $obj->getIdempresa());
            ...
            $criteria->add(FoliotablajeriaPeer::IDEMPRESA, $obj->getIdempresa());
            ...
            $criteria->add(NotificacionPeer::IDEMPRESA, $obj->getIdempresa());
            ...
            $criteria->add(ProductocfdiPeer::IDEMPRESA, $obj->getIdempresa());
