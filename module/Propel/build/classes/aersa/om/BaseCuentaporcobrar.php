...
/**
 * Base class that represents a row from the 'cuentaporcobrar' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseCuentaporcobrar extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CuentaporcobrarPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CuentaporcobrarPeer
     */
    ...
    /**
     * The value for the cuentaporcobrar_cantidad field.
     * @var        string
     */
    protected $cuentaporcobrar_cantidad;

    /**
     * The value for the cuentaporcobrar_cliente field.
     * @var        string
     */
    protected $cuentaporcobrar_cliente;

    /**
     * The value for the cuentaporcobrar_fecha field.
     * @var        string
     */
    protected $cuentaporcobrar_fecha;

    /**
     * The value for the cuentaporcobrar_referencia field.
     * @var        string
     */
    protected $cuentaporcobrar_referencia;

    /**
     * The value for the cuentaporcobrar_abonado field.
    ...
    /**
     * The value for the cuentaporcobrar_comprobante field.
     * @var        string
     */
    protected $cuentaporcobrar_comprobante;
    ...
    {
        $this->cuentaporcobrar_abonado = '0.00000';
    }

    /**
     * Initializes internal state of BaseCuentaporcobrar object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [cuentaporcobrar_cantidad] column value.
     *
     * @return string
     */
    public function getCuentaporcobrarCantidad()
    {

        return $this->cuentaporcobrar_cantidad;
    }

    /**
     * Get the [cuentaporcobrar_cliente] column value.
     *
     * @return string
     */
    public function getCuentaporcobrarCliente()
    {

        return $this->cuentaporcobrar_cliente;
    }

    /**
     * Get the [optionally formatted] temporal [cuentaporcobrar_fecha] column value.
     *
     *
     ...
     */
    public function getCuentaporcobrarFecha($format = 'Y-m-d H:i:s')
    {
        if ($this->cuentaporcobrar_fecha === null) {
            return null;
        }

        if ($this->cuentaporcobrar_fecha === '0000-00-00 00:00:00') {
        ...
        try {
            $dt = new DateTime($this->cuentaporcobrar_fecha);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->cuentaporcobrar_fecha, true), $x);
        }
    ...
    /**
     * Get the [cuentaporcobrar_referencia] column value.
     *
     * @return string
     */
    public function getCuentaporcobrarReferencia()
    {

        return $this->cuentaporcobrar_referencia;
    }

    /**
     * Get the [cuentaporcobrar_abonado] column value.
     *
     * @return string
     */
    public function getCuentaporcobrarAbonado()
    {
    ...
    /**
     * Get the [cuentaporcobrar_comprobante] column value.
     *
     * @return string
     */
    public function getCuentaporcobrarComprobante()
    {

        return $this->cuentaporcobrar_comprobante;
    }
    ...
    public function setIdcuentaporcobrar($v)
    {
        ...
        if ($this->idcuentaporcobrar !== $v) {
            ...
            $this->modifiedColumns[] = CuentaporcobrarPeer::IDCUENTAPORCOBRAR;
        }
    ...
    public function setIdempresa($v)
    {
        ...
        if ($this->idempresa !== $v) {
            $this->idempresa = $v;
            $this->modifiedColumns[] = CuentaporcobrarPeer::IDEMPRESA;
        }
    ...
    public function setIdsucursal($v)
    {
        ...
        if ($this->idsucursal !== $v) {
            $this->idsucursal = $v;
            $this->modifiedColumns[] = CuentaporcobrarPeer::IDSUCURSAL;
        }
    ...
    public function setIdusuario($v)
    {
        ...
        if ($this->idusuario !== $v) {
            $this->idusuario = $v;
            $this->modifiedColumns[] = CuentaporcobrarPeer::IDUSUARIO;
        }
    ...
    /**
     * Set the value of [cuentaporcobrar_cantidad] column.
     *
     * @param  string $v new value
     * @return Cuentaporcobrar The current object (for fluent API support)
     */
    public function setCuentaporcobrarCantidad($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->cuentaporcobrar_cantidad !== $v) {
            $this->cuentaporcobrar_cantidad = $v;
            $this->modifiedColumns[] = CuentaporcobrarPeer::CUENTAPORCOBRAR_CANTIDAD;
        }


        return $this;
    } // setCuentaporcobrarCantidad()

    /**
     * Set the value of [cuentaporcobrar_cliente] column.
     *
     * @param  string $v new value
     * @return Cuentaporcobrar The current object (for fluent API support)
     */
    public function setCuentaporcobrarCliente($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->cuentaporcobrar_cliente !== $v) {
            $this->cuentaporcobrar_cliente = $v;
            $this->modifiedColumns[] = CuentaporcobrarPeer::CUENTAPORCOBRAR_CLIENTE;
        }


        return $this;
    } // setCuentaporcobrarCliente()

    /**
     * Sets the value of [cuentaporcobrar_fecha] column to a normalized version of the date/time value specified.
     *
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Cuentaporcobrar The current object (for fluent API support)
     */
    public function setCuentaporcobrarFecha($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->cuentaporcobrar_fecha !== null || $dt !== null) {
            $currentDateAsString = ($this->cuentaporcobrar_fecha !== null && $tmpDt = new DateTime($this->cuentaporcobrar_fecha)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->cuentaporcobrar_fecha = $newDateAsString;
                $this->modifiedColumns[] = CuentaporcobrarPeer::CUENTAPORCOBRAR_FECHA;
            }
        } // if either are not null


        return $this;
    } // setCuentaporcobrarFecha()

    /**
     * Set the value of [cuentaporcobrar_referencia] column.
     *
     * @param  string $v new value
     * @return Cuentaporcobrar The current object (for fluent API support)
     */
    public function setCuentaporcobrarReferencia($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->cuentaporcobrar_referencia !== $v) {
            $this->cuentaporcobrar_referencia = $v;
            $this->modifiedColumns[] = CuentaporcobrarPeer::CUENTAPORCOBRAR_REFERENCIA;
        }


        return $this;
    } // setCuentaporcobrarReferencia()

    /**
     * Set the value of [cuentaporcobrar_abonado] column.
     *
     * @param  string $v new value
     * @return Cuentaporcobrar The current object (for fluent API support)
     */
    public function setCuentaporcobrarAbonado($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->cuentaporcobrar_abonado !== $v) {
            $this->cuentaporcobrar_abonado = $v;
            $this->modifiedColumns[] = CuentaporcobrarPeer::CUENTAPORCOBRAR_ABONADO;
        }
    ...
    /**
     * Set the value of [cuentaporcobrar_comprobante] column.
     *
     * @param  string $v new value
     * @return Cuentaporcobrar The current object (for fluent API support)
     */
    public function setCuentaporcobrarComprobante($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->cuentaporcobrar_comprobante !== $v) {
            $this->cuentaporcobrar_comprobante = $v;
            $this->modifiedColumns[] = CuentaporcobrarPeer::CUENTAPORCOBRAR_COMPROBANTE;
        }


        return $this;
    } // setCuentaporcobrarComprobante()
    ...
    {
            if ($this->cuentaporcobrar_abonado !== '0.00000') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idcuentaporcobrar = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            $this->cuentaporcobrar_cantidad = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->cuentaporcobrar_cliente = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->cuentaporcobrar_fecha = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->cuentaporcobrar_referencia = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            ...
            $this->cuentaporcobrar_comprobante = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->resetModified();
            ...
            return $startcol + 11; // 11 = CuentaporcobrarPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CuentaporcobrarPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CuentaporcobrarQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CuentaporcobrarPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = CuentaporcobrarPeer::IDCUENTAPORCOBRAR;
        if (null !== $this->idcuentaporcobrar) {
        ...
        if ($this->isColumnModified(CuentaporcobrarPeer::IDCUENTAPORCOBRAR)) {
            $modifiedColumns[':p' . $index++]  = '`idcuentaporcobrar`';
        }
        if ($this->isColumnModified(CuentaporcobrarPeer::IDEMPRESA)) {
            $modifiedColumns[':p' . $index++]  = '`idempresa`';
        }
        if ($this->isColumnModified(CuentaporcobrarPeer::IDSUCURSAL)) {
            $modifiedColumns[':p' . $index++]  = '`idsucursal`';
        }
        if ($this->isColumnModified(CuentaporcobrarPeer::IDUSUARIO)) {
            $modifiedColumns[':p' . $index++]  = '`idusuario`';
        }
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_CANTIDAD)) {
            $modifiedColumns[':p' . $index++]  = '`cuentaporcobrar_cantidad`';
        }
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_CLIENTE)) {
            $modifiedColumns[':p' . $index++]  = '`cuentaporcobrar_cliente`';
        }
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_FECHA)) {
            $modifiedColumns[':p' . $index++]  = '`cuentaporcobrar_fecha`';
        }
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_REFERENCIA)) {
            $modifiedColumns[':p' . $index++]  = '`cuentaporcobrar_referencia`';
        }
        ...
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_COMPROBANTE)) {
            $modifiedColumns[':p' . $index++]  = '`cuentaporcobrar_comprobante`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`idusuario`':
                        ...
                        break;
                    case '`cuentaporcobrar_cantidad`':
                        $stmt->bindValue($identifier, $this->cuentaporcobrar_cantidad, PDO::PARAM_STR);
                        break;
                    case '`cuentaporcobrar_cliente`':
                        $stmt->bindValue($identifier, $this->cuentaporcobrar_cliente, PDO::PARAM_STR);
                        break;
                    case '`cuentaporcobrar_fecha`':
                        $stmt->bindValue($identifier, $this->cuentaporcobrar_fecha, PDO::PARAM_STR);
                        break;
                    case '`cuentaporcobrar_referencia`':
                        $stmt->bindValue($identifier, $this->cuentaporcobrar_referencia, PDO::PARAM_STR);
                        break;
                    ...
                    case '`cuentaporcobrar_estatuspago`':
                        ...
                        break;
                    case '`cuentaporcobrar_comprobante`':
                        $stmt->bindValue($identifier, $this->cuentaporcobrar_comprobante, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CuentaporcobrarPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CuentaporcobrarPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                return $this->getCuentaporcobrarCantidad();
                break;
            case 5:
                return $this->getCuentaporcobrarCliente();
                break;
            case 6:
                return $this->getCuentaporcobrarFecha();
                break;
            case 7:
                return $this->getCuentaporcobrarReferencia();
                break;
            case 8:
            ...
            case 9:
                ...
                break;
            case 10:
                return $this->getCuentaporcobrarComprobante();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Cuentaporcobrar'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Cuentaporcobrar'][$this->getPrimaryKey()] = true;
        $keys = CuentaporcobrarPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdcuentaporcobrar(),
            $keys[1] => $this->getIdempresa(),
            $keys[2] => $this->getIdsucursal(),
            $keys[3] => $this->getIdusuario(),
            $keys[4] => $this->getCuentaporcobrarCantidad(),
            $keys[5] => $this->getCuentaporcobrarCliente(),
            $keys[6] => $this->getCuentaporcobrarFecha(),
            $keys[7] => $this->getCuentaporcobrarReferencia(),
            $keys[8] => $this->getCuentaporcobrarAbonado(),
            $keys[9] => $this->getCuentaporcobrarEstatuspago(),
            $keys[10] => $this->getCuentaporcobrarComprobante(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                $this->setCuentaporcobrarCantidad($value);
                break;
            case 5:
                $this->setCuentaporcobrarCliente($value);
                break;
            case 6:
                $this->setCuentaporcobrarFecha($value);
                break;
            case 7:
                $this->setCuentaporcobrarReferencia($value);
                break;
            case 8:
            ...
            case 9:
                ...
                break;
            case 10:
                $this->setCuentaporcobrarComprobante($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdcuentaporcobrar($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[4], $arr)) $this->setCuentaporcobrarCantidad($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setCuentaporcobrarCliente($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setCuentaporcobrarFecha($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setCuentaporcobrarReferencia($arr[$keys[7]]);
        ...
        if (array_key_exists($keys[10], $arr)) $this->setCuentaporcobrarComprobante($arr[$keys[10]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CuentaporcobrarPeer::IDCUENTAPORCOBRAR)) $criteria->add(CuentaporcobrarPeer::IDCUENTAPORCOBRAR, $this->idcuentaporcobrar);
        if ($this->isColumnModified(CuentaporcobrarPeer::IDEMPRESA)) $criteria->add(CuentaporcobrarPeer::IDEMPRESA, $this->idempresa);
        if ($this->isColumnModified(CuentaporcobrarPeer::IDSUCURSAL)) $criteria->add(CuentaporcobrarPeer::IDSUCURSAL, $this->idsucursal);
        if ($this->isColumnModified(CuentaporcobrarPeer::IDUSUARIO)) $criteria->add(CuentaporcobrarPeer::IDUSUARIO, $this->idusuario);
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_CANTIDAD)) $criteria->add(CuentaporcobrarPeer::CUENTAPORCOBRAR_CANTIDAD, $this->cuentaporcobrar_cantidad);
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_CLIENTE)) $criteria->add(CuentaporcobrarPeer::CUENTAPORCOBRAR_CLIENTE, $this->cuentaporcobrar_cliente);
        ...
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_REFERENCIA)) $criteria->add(CuentaporcobrarPeer::CUENTAPORCOBRAR_REFERENCIA, $this->cuentaporcobrar_referencia);
        ...
        if ($this->isColumnModified(CuentaporcobrarPeer::CUENTAPORCOBRAR_COMPROBANTE)) $criteria->add(CuentaporcobrarPeer::CUENTAPORCOBRAR_COMPROBANTE, $this->cuentaporcobrar_comprobante);
    ...
    {
        $criteria = new Criteria(CuentaporcobrarPeer::DATABASE_NAME);
        $criteria->add(CuentaporcobrarPeer::IDCUENTAPORCOBRAR, $this->idcuentaporcobrar);
    ...
    /**
     * Generic method to set the primary key (idcuentaporcobrar column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdcuentaporcobrar();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Cuentaporcobrar (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCuentaporcobrarCantidad($this->getCuentaporcobrarCantidad());
        $copyObj->setCuentaporcobrarCliente($this->getCuentaporcobrarCliente());
        $copyObj->setCuentaporcobrarFecha($this->getCuentaporcobrarFecha());
        $copyObj->setCuentaporcobrarReferencia($this->getCuentaporcobrarReferencia());
        ...
        $copyObj->setCuentaporcobrarComprobante($this->getCuentaporcobrarComprobante());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdcuentaporcobrar(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Cuentaporcobrar Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CuentaporcobrarPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CuentaporcobrarPeer();
        }
    ...
    public function getEmpresa(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpresa === null && ($this->idempresa !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpresa->addCuentaporcobrars($this);
             */
        }
    ...
    public function getSucursal(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSucursal === null && ($this->idsucursal !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSucursal->addCuentaporcobrars($this);
             */
        }
    ...
    public function getUsuario(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuario === null && ($this->idusuario !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuario->addCuentaporcobrars($this);
             */
        }
     ...
     * If this Cuentaporcobrar is new, it will return
    ...
    public function setFlujoefectivos(PropelCollection $flujoefectivos, PropelPDO $con = null)
    {
        ...
        foreach ($flujoefectivosToDelete as $flujoefectivoRemoved) {
            $flujoefectivoRemoved->setCuentaporcobrar(null);
        }
    ...
    protected function doAddFlujoefectivo($flujoefectivo)
    {
        ...
        $flujoefectivo->setCuentaporcobrar($this);
    }
    ...
    public function removeFlujoefectivo($flujoefectivo)
    {
        if ($this->getFlujoefectivos()->contains($flujoefectivo)) {
            ...
            $flujoefectivo->setCuentaporcobrar(null);
        }
     ...
     * Otherwise if this Cuentaporcobrar is new, it will return
     * an empty collection; or if this Cuentaporcobrar has previously
     * been saved, it will retrieve related Flujoefectivos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Cuentaporcobrar.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function clear()
    {
        ...
        $this->idusuario = null;
        $this->cuentaporcobrar_cantidad = null;
        $this->cuentaporcobrar_cliente = null;
        $this->cuentaporcobrar_fecha = null;
        $this->cuentaporcobrar_referencia = null;
        $this->cuentaporcobrar_abonado = null;
        $this->cuentaporcobrar_estatuspago = null;
        $this->cuentaporcobrar_comprobante = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(CuentaporcobrarPeer::DEFAULT_STRING_FORMAT);
    }
