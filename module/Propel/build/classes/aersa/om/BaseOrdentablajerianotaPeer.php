...
abstract class BaseOrdentablajerianotaPeer
{
    ...
    public static function doCountJoinOrdentablajeria(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrdentablajerianotaPeer::IDORDENTABLAJERIA, OrdentablajeriaPeer::IDORDENTABLAJERIA, $join_behavior);
    ...
    public static function doCountJoinUsuario(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrdentablajerianotaPeer::IDUSUARIO, UsuarioPeer::IDUSUARIO, $join_behavior);
    ...
    /**
     * Selects a collection of Ordentablajerianota objects pre-filled with their Ordentablajeria objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Ordentablajerianota objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinOrdentablajeria(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        OrdentablajerianotaPeer::addSelectColumns($criteria);
        $startcol = OrdentablajerianotaPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = OrdentablajerianotaPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = OrdentablajerianotaPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                OrdentablajerianotaPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Ordentablajerianota) to $obj2 (Ordentablajeria)
                $obj2->addOrdentablajerianota($obj1);
    ...
    /**
     * Selects a collection of Ordentablajerianota objects pre-filled with their Usuario objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Ordentablajerianota objects.
    ...
    public static function doSelectJoinUsuario(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Ordentablajerianota) to $obj2 (Usuario)
                $obj2->addOrdentablajerianota($obj1);
    ...
    /**
     * Selects a collection of Ordentablajerianota objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        OrdentablajerianotaPeer::addSelectColumns($criteria);
        $startcol2 = OrdentablajerianotaPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Ordentablajerianota) to the collection in $obj2 (Ordentablajeria)
                $obj2->addOrdentablajerianota($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Ordentablajerianota) to the collection in $obj3 (Usuario)
                $obj3->addOrdentablajerianota($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Ordentablajerianota objects pre-filled with all related objects except Ordentablajeria.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptOrdentablajeria(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = OrdentablajerianotaPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Ordentablajerianota) to the collection in $obj2 (Usuario)
                $obj2->addOrdentablajerianota($obj1);
    ...
    /**
     * Selects a collection of Ordentablajerianota objects pre-filled with all related objects except Usuario.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
