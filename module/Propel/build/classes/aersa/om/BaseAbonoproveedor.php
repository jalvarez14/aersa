...
/**
 * Base class that represents a row from the 'abonoproveedor' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseAbonoproveedor extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AbonoproveedorPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AbonoproveedorPeer
     */
    ...
    public function setIdabonoproveedor($v)
    {
        ...
        if ($this->idabonoproveedor !== $v) {
            ...
            $this->modifiedColumns[] = AbonoproveedorPeer::IDABONOPROVEEDOR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = AbonoproveedorPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Abonoproveedor object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AbonoproveedorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AbonoproveedorQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AbonoproveedorPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `abonoproveedor` (%s) VALUES (%s)',
    ...
    {
        $pos = AbonoproveedorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Abonoproveedor'][$this->getPrimaryKey()] = true;
    ...
    {
        $criteria = new Criteria(AbonoproveedorPeer::DATABASE_NAME);
        $criteria->add(AbonoproveedorPeer::IDABONOPROVEEDOR, $this->idabonoproveedor);
    ...
    /**
     * Generic method to set the primary key (idabonoproveedor column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdabonoproveedor();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Abonoproveedor (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Abonoproveedor Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AbonoproveedorPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AbonoproveedorPeer();
        }
    ...
    {
        return (string) $this->exportTo(AbonoproveedorPeer::DEFAULT_STRING_FORMAT);
    }
