...
abstract class BaseCompradetalle extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the compradetalle_precio field.
     * @var        string
     */
    protected $compradetalle_precio;

    /**
     * The value for the compradetalle_revisada field.
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $compradetalle_revisada;
    ...
    /**
     * The value for the compradetalle_costounitarioneto field.
     * @var        string
     */
    protected $compradetalle_costounitarioneto;

    /**
     * The value for the compradetalle_descuento field.
     * @var        double
     */
    protected $compradetalle_descuento;

    /**
     * The value for the compradetalle_ieps field.
     * @var        double
     */
    protected $compradetalle_ieps;
    ...
    {
        $this->compradetalle_revisada = false;
    }

    /**
     * Initializes internal state of BaseCompradetalle object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [compradetalle_precio] column value.
     *
     * @return string
     */
    public function getCompradetallePrecio()
    {

        return $this->compradetalle_precio;
    }

    /**
     * Get the [compradetalle_revisada] column value.
     *
     * @return boolean
     */
    public function getCompradetalleRevisada()
    {

        return $this->compradetalle_revisada;
    }
    ...
    /**
     * Get the [compradetalle_costounitarioneto] column value.
     *
     * @return string
     */
    public function getCompradetalleCostounitarioneto()
    {

        return $this->compradetalle_costounitarioneto;
    }

    /**
     * Get the [compradetalle_descuento] column value.
     *
     * @return double
     */
    public function getCompradetalleDescuento()
    {

        return $this->compradetalle_descuento;
    }

    /**
     * Get the [compradetalle_ieps] column value.
     *
     * @return double
     */
    public function getCompradetalleIeps()
    {

        return $this->compradetalle_ieps;
    }
    ...
    public function setIdproducto($v)
    {
        ...
        if ($this->idproducto !== $v) {
            $this->idproducto = $v;
            $this->modifiedColumns[] = CompradetallePeer::IDPRODUCTO;
        }
    ...
    public function setIdalmacen($v)
    {
        ...
        if ($this->idalmacen !== $v) {
            $this->idalmacen = $v;
            $this->modifiedColumns[] = CompradetallePeer::IDALMACEN;
        }
    ...
    /**
     * Set the value of [compradetalle_precio] column.
     *
     * @param  string $v new value
     * @return Compradetalle The current object (for fluent API support)
     */
    public function setCompradetallePrecio($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->compradetalle_precio !== $v) {
            $this->compradetalle_precio = $v;
            $this->modifiedColumns[] = CompradetallePeer::COMPRADETALLE_PRECIO;
        }


        return $this;
    } // setCompradetallePrecio()

    /**
     * Sets the value of the [compradetalle_revisada] column.
     ...
     * @return Compradetalle The current object (for fluent API support)
     */
    public function setCompradetalleRevisada($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->compradetalle_revisada !== $v) {
            $this->compradetalle_revisada = $v;
            $this->modifiedColumns[] = CompradetallePeer::COMPRADETALLE_REVISADA;
        }


        return $this;
    } // setCompradetalleRevisada()
    ...
    /**
     * Set the value of [compradetalle_costounitarioneto] column.
     *
     * @param  string $v new value
     * @return Compradetalle The current object (for fluent API support)
     */
    public function setCompradetalleCostounitarioneto($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->compradetalle_costounitarioneto !== $v) {
            $this->compradetalle_costounitarioneto = $v;
            $this->modifiedColumns[] = CompradetallePeer::COMPRADETALLE_COSTOUNITARIONETO;
        }


        return $this;
    } // setCompradetalleCostounitarioneto()

    /**
     * Set the value of [compradetalle_descuento] column.
     *
     * @param  double $v new value
     * @return Compradetalle The current object (for fluent API support)
     */
    public function setCompradetalleDescuento($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (double) $v;
        }

        if ($this->compradetalle_descuento !== $v) {
            $this->compradetalle_descuento = $v;
            $this->modifiedColumns[] = CompradetallePeer::COMPRADETALLE_DESCUENTO;
        }


        return $this;
    } // setCompradetalleDescuento()

    /**
     * Set the value of [compradetalle_ieps] column.
     *
     * @param  double $v new value
     * @return Compradetalle The current object (for fluent API support)
     */
    public function setCompradetalleIeps($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (double) $v;
        }

        if ($this->compradetalle_ieps !== $v) {
            $this->compradetalle_ieps = $v;
            $this->modifiedColumns[] = CompradetallePeer::COMPRADETALLE_IEPS;
        }


        return $this;
    } // setCompradetalleIeps()
    ...
    {
            if ($this->compradetalle_revisada !== false) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->compradetalle_cantidad = ($row[$startcol + 4] !== null) ? (double) $row[$startcol + 4] : null;
            $this->compradetalle_precio = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->compradetalle_revisada = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
            $this->compradetalle_costounitario = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->compradetalle_costounitarioneto = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->compradetalle_descuento = ($row[$startcol + 9] !== null) ? (double) $row[$startcol + 9] : null;
            $this->compradetalle_ieps = ($row[$startcol + 10] !== null) ? (double) $row[$startcol + 10] : null;
            $this->compradetalle_subtotal = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->resetModified();
            ...
            return $startcol + 12; // 12 = CompradetallePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompradetallePeer::IDPRODUCTO)) {
            $modifiedColumns[':p' . $index++]  = '`idproducto`';
        }
        if ($this->isColumnModified(CompradetallePeer::IDALMACEN)) {
        ...
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_PRECIO)) {
            $modifiedColumns[':p' . $index++]  = '`compradetalle_precio`';
        }
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_REVISADA)) {
            $modifiedColumns[':p' . $index++]  = '`compradetalle_revisada`';
        }
        ...
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_COSTOUNITARIONETO)) {
            $modifiedColumns[':p' . $index++]  = '`compradetalle_costounitarioneto`';
        }
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_DESCUENTO)) {
            $modifiedColumns[':p' . $index++]  = '`compradetalle_descuento`';
        }
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_IEPS)) {
            $modifiedColumns[':p' . $index++]  = '`compradetalle_ieps`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`compradetalle_cantidad`':
                        ...
                        break;
                    case '`compradetalle_precio`':
                        $stmt->bindValue($identifier, $this->compradetalle_precio, PDO::PARAM_STR);
                        break;
                    case '`compradetalle_revisada`':
                        $stmt->bindValue($identifier, (int) $this->compradetalle_revisada, PDO::PARAM_INT);
                        break;
                    case '`compradetalle_costounitario`':
                        $stmt->bindValue($identifier, $this->compradetalle_costounitario, PDO::PARAM_STR);
                        break;
                    case '`compradetalle_costounitarioneto`':
                        $stmt->bindValue($identifier, $this->compradetalle_costounitarioneto, PDO::PARAM_STR);
                        break;
                    case '`compradetalle_descuento`':
                        $stmt->bindValue($identifier, $this->compradetalle_descuento, PDO::PARAM_STR);
                        break;
                    case '`compradetalle_ieps`':
                        $stmt->bindValue($identifier, $this->compradetalle_ieps, PDO::PARAM_STR);
                        break;
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                return $this->getCompradetallePrecio();
                break;
            case 6:
                return $this->getCompradetalleRevisada();
                break;
            case 7:
                return $this->getCompradetalleCostounitario();
                break;
            case 8:
                return $this->getCompradetalleCostounitarioneto();
                break;
            case 9:
                return $this->getCompradetalleDescuento();
                break;
            case 10:
                return $this->getCompradetalleIeps();
                break;
            case 11:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getCompradetallePrecio(),
            $keys[6] => $this->getCompradetalleRevisada(),
            $keys[7] => $this->getCompradetalleCostounitario(),
            $keys[8] => $this->getCompradetalleCostounitarioneto(),
            $keys[9] => $this->getCompradetalleDescuento(),
            $keys[10] => $this->getCompradetalleIeps(),
            $keys[11] => $this->getCompradetalleSubtotal(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                $this->setCompradetallePrecio($value);
                break;
            case 6:
                $this->setCompradetalleRevisada($value);
                break;
            case 7:
                $this->setCompradetalleCostounitario($value);
                break;
            case 8:
                $this->setCompradetalleCostounitarioneto($value);
                break;
            case 9:
                $this->setCompradetalleDescuento($value);
                break;
            case 10:
                $this->setCompradetalleIeps($value);
                break;
            case 11:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setCompradetallePrecio($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setCompradetalleRevisada($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setCompradetalleCostounitario($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setCompradetalleCostounitarioneto($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setCompradetalleDescuento($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setCompradetalleIeps($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setCompradetalleSubtotal($arr[$keys[11]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompradetallePeer::IDPRODUCTO)) $criteria->add(CompradetallePeer::IDPRODUCTO, $this->idproducto);
        if ($this->isColumnModified(CompradetallePeer::IDALMACEN)) $criteria->add(CompradetallePeer::IDALMACEN, $this->idalmacen);
        ...
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_PRECIO)) $criteria->add(CompradetallePeer::COMPRADETALLE_PRECIO, $this->compradetalle_precio);
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_REVISADA)) $criteria->add(CompradetallePeer::COMPRADETALLE_REVISADA, $this->compradetalle_revisada);
        ...
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_COSTOUNITARIONETO)) $criteria->add(CompradetallePeer::COMPRADETALLE_COSTOUNITARIONETO, $this->compradetalle_costounitarioneto);
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_DESCUENTO)) $criteria->add(CompradetallePeer::COMPRADETALLE_DESCUENTO, $this->compradetalle_descuento);
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_IEPS)) $criteria->add(CompradetallePeer::COMPRADETALLE_IEPS, $this->compradetalle_ieps);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCompradetallePrecio($this->getCompradetallePrecio());
        $copyObj->setCompradetalleRevisada($this->getCompradetalleRevisada());
        $copyObj->setCompradetalleCostounitario($this->getCompradetalleCostounitario());
        $copyObj->setCompradetalleCostounitarioneto($this->getCompradetalleCostounitarioneto());
        $copyObj->setCompradetalleDescuento($this->getCompradetalleDescuento());
        $copyObj->setCompradetalleIeps($this->getCompradetalleIeps());
    ...
    public function getAlmacen(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAlmacen === null && ($this->idalmacen !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAlmacen->addCompradetalles($this);
             */
        }
    ...
    public function getProducto(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProducto === null && ($this->idproducto !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProducto->addCompradetalles($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->compradetalle_precio = null;
        $this->compradetalle_revisada = null;
        $this->compradetalle_costounitario = null;
        $this->compradetalle_costounitarioneto = null;
        $this->compradetalle_descuento = null;
        $this->compradetalle_ieps = null;
