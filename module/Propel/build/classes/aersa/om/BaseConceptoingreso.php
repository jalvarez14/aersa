...
/**
 * Base class that represents a row from the 'conceptoingreso' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseConceptoingreso extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ConceptoingresoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ConceptoingresoPeer
     */
    ...
    /**
     * The value for the conceptoingreso_nombre field.
     * @var        string
     */
    protected $conceptoingreso_nombre;

    /**
     * The value for the conceptoingreso_descripcion field.
     * @var        string
     */
    protected $conceptoingreso_descripcion;
    ...
    /**
     * Get the [conceptoingreso_nombre] column value.
     *
     * @return string
     */
    public function getConceptoingresoNombre()
    {

        return $this->conceptoingreso_nombre;
    }

    /**
     * Get the [conceptoingreso_descripcion] column value.
     *
     * @return string
     */
    public function getConceptoingresoDescripcion()
    {

        return $this->conceptoingreso_descripcion;
    }
     ...
     * @return Conceptoingreso The current object (for fluent API support)
     */
    public function setIdconceptoingreso($v)
    {
        ...
        if ($this->idconceptoingreso !== $v) {
            ...
            $this->modifiedColumns[] = ConceptoingresoPeer::IDCONCEPTOINGRESO;
        }
    ...
    /**
     * Set the value of [conceptoingreso_nombre] column.
     *
     * @param  string $v new value
     * @return Conceptoingreso The current object (for fluent API support)
     */
    public function setConceptoingresoNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->conceptoingreso_nombre !== $v) {
            $this->conceptoingreso_nombre = $v;
            $this->modifiedColumns[] = ConceptoingresoPeer::CONCEPTOINGRESO_NOMBRE;
        }


        return $this;
    } // setConceptoingresoNombre()

    /**
     * Set the value of [conceptoingreso_descripcion] column.
     *
     * @param  string $v new value
     * @return Conceptoingreso The current object (for fluent API support)
     */
    public function setConceptoingresoDescripcion($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->conceptoingreso_descripcion !== $v) {
            $this->conceptoingreso_descripcion = $v;
            $this->modifiedColumns[] = ConceptoingresoPeer::CONCEPTOINGRESO_DESCRIPCION;
        }


        return $this;
    } // setConceptoingresoDescripcion()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idconceptoingreso = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->conceptoingreso_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->conceptoingreso_descripcion = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ConceptoingresoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Conceptoingreso object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ConceptoingresoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ConceptoingresoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ConceptoingresoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ConceptoingresoPeer::IDCONCEPTOINGRESO;
        if (null !== $this->idconceptoingreso) {
        ...
        if ($this->isColumnModified(ConceptoingresoPeer::IDCONCEPTOINGRESO)) {
            $modifiedColumns[':p' . $index++]  = '`idconceptoingreso`';
        }
        if ($this->isColumnModified(ConceptoingresoPeer::CONCEPTOINGRESO_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`conceptoingreso_nombre`';
        }
        if ($this->isColumnModified(ConceptoingresoPeer::CONCEPTOINGRESO_DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`conceptoingreso_descripcion`';
        }

        $sql = sprintf(
            'INSERT INTO `conceptoingreso` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idconceptoingreso`':
                        ...
                        break;
                    case '`conceptoingreso_nombre`':
                        $stmt->bindValue($identifier, $this->conceptoingreso_nombre, PDO::PARAM_STR);
                        break;
                    case '`conceptoingreso_descripcion`':
                        $stmt->bindValue($identifier, $this->conceptoingreso_descripcion, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ConceptoingresoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ConceptoingresoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getConceptoingresoNombre();
                break;
            case 2:
                return $this->getConceptoingresoDescripcion();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Conceptoingreso'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Conceptoingreso'][$this->getPrimaryKey()] = true;
        $keys = ConceptoingresoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdconceptoingreso(),
            $keys[1] => $this->getConceptoingresoNombre(),
            $keys[2] => $this->getConceptoingresoDescripcion(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setConceptoingresoNombre($value);
                break;
            case 2:
                $this->setConceptoingresoDescripcion($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdconceptoingreso($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setConceptoingresoNombre($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setConceptoingresoDescripcion($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConceptoingresoPeer::IDCONCEPTOINGRESO)) $criteria->add(ConceptoingresoPeer::IDCONCEPTOINGRESO, $this->idconceptoingreso);
        if ($this->isColumnModified(ConceptoingresoPeer::CONCEPTOINGRESO_NOMBRE)) $criteria->add(ConceptoingresoPeer::CONCEPTOINGRESO_NOMBRE, $this->conceptoingreso_nombre);
        if ($this->isColumnModified(ConceptoingresoPeer::CONCEPTOINGRESO_DESCRIPCION)) $criteria->add(ConceptoingresoPeer::CONCEPTOINGRESO_DESCRIPCION, $this->conceptoingreso_descripcion);
    ...
    {
        $criteria = new Criteria(ConceptoingresoPeer::DATABASE_NAME);
        $criteria->add(ConceptoingresoPeer::IDCONCEPTOINGRESO, $this->idconceptoingreso);
    ...
    /**
     * Generic method to set the primary key (idconceptoingreso column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdconceptoingreso();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Conceptoingreso (or compatible) type.
    ...
    {
        $copyObj->setConceptoingresoNombre($this->getConceptoingresoNombre());
        $copyObj->setConceptoingresoDescripcion($this->getConceptoingresoDescripcion());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdconceptoingreso(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Conceptoingreso Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ConceptoingresoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ConceptoingresoPeer();
        }
     ...
     * If this Conceptoingreso is new, it will return
    ...
    public function setIngresodetalles(PropelCollection $ingresodetalles, PropelPDO $con = null)
    {
        ...
        foreach ($ingresodetallesToDelete as $ingresodetalleRemoved) {
            $ingresodetalleRemoved->setConceptoingreso(null);
        }
    ...
    protected function doAddIngresodetalle($ingresodetalle)
    {
        ...
        $ingresodetalle->setConceptoingreso($this);
    }
    ...
    public function removeIngresodetalle($ingresodetalle)
    {
        if ($this->getIngresodetalles()->contains($ingresodetalle)) {
            ...
            $ingresodetalle->setConceptoingreso(null);
        }
     ...
     * Otherwise if this Conceptoingreso is new, it will return
     * an empty collection; or if this Conceptoingreso has previously
     * been saved, it will retrieve related Ingresodetalles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Conceptoingreso.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Ingresodetalle[] List of Ingresodetalle objects
     */
    public function getIngresodetallesJoinIngreso($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = IngresodetalleQuery::create(null, $criteria);
    ...
    public function clear()
    {
        ...
        $this->conceptoingreso_nombre = null;
        $this->conceptoingreso_descripcion = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(ConceptoingresoPeer::DEFAULT_STRING_FORMAT);
    }
