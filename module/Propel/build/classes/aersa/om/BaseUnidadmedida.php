...
/**
 * Base class that represents a row from the 'unidadmedida' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseUnidadmedida extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UnidadmedidaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        UnidadmedidaPeer
     */
    ...
    /**
     * The value for the unidadmedida_nombre field.
     * @var        string
     */
    protected $unidadmedida_nombre;
    ...
    /**
     * Get the [unidadmedida_nombre] column value.
     *
     * @return string
     */
    public function getUnidadmedidaNombre()
    {

        return $this->unidadmedida_nombre;
    }
     ...
     * @return Unidadmedida The current object (for fluent API support)
     */
    public function setIdunidadmedida($v)
    {
        ...
        if ($this->idunidadmedida !== $v) {
            ...
            $this->modifiedColumns[] = UnidadmedidaPeer::IDUNIDADMEDIDA;
        }
    ...
    /**
     * Set the value of [unidadmedida_nombre] column.
     *
     * @param  string $v new value
     * @return Unidadmedida The current object (for fluent API support)
     */
    public function setUnidadmedidaNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->unidadmedida_nombre !== $v) {
            $this->unidadmedida_nombre = $v;
            $this->modifiedColumns[] = UnidadmedidaPeer::UNIDADMEDIDA_NOMBRE;
        }


        return $this;
    } // setUnidadmedidaNombre()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idunidadmedida = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->unidadmedida_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = UnidadmedidaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Unidadmedida object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UnidadmedidaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UnidadmedidaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UnidadmedidaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UnidadmedidaPeer::IDUNIDADMEDIDA)) {
            $modifiedColumns[':p' . $index++]  = '`idunidadmedida`';
        }
        if ($this->isColumnModified(UnidadmedidaPeer::UNIDADMEDIDA_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`unidadmedida_nombre`';
        }

        $sql = sprintf(
            'INSERT INTO `unidadmedida` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idunidadmedida`':
                        ...
                        break;
                    case '`unidadmedida_nombre`':
                        $stmt->bindValue($identifier, $this->unidadmedida_nombre, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UnidadmedidaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UnidadmedidaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getUnidadmedidaNombre();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Unidadmedida'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Unidadmedida'][$this->getPrimaryKey()] = true;
        $keys = UnidadmedidaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdunidadmedida(),
            $keys[1] => $this->getUnidadmedidaNombre(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setUnidadmedidaNombre($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdunidadmedida($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setUnidadmedidaNombre($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UnidadmedidaPeer::IDUNIDADMEDIDA)) $criteria->add(UnidadmedidaPeer::IDUNIDADMEDIDA, $this->idunidadmedida);
        if ($this->isColumnModified(UnidadmedidaPeer::UNIDADMEDIDA_NOMBRE)) $criteria->add(UnidadmedidaPeer::UNIDADMEDIDA_NOMBRE, $this->unidadmedida_nombre);
    ...
    {
        $criteria = new Criteria(UnidadmedidaPeer::DATABASE_NAME);
        $criteria->add(UnidadmedidaPeer::IDUNIDADMEDIDA, $this->idunidadmedida);
    ...
    /**
     * Generic method to set the primary key (idunidadmedida column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdunidadmedida();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Unidadmedida (or compatible) type.
    ...
    {
        $copyObj->setUnidadmedidaNombre($this->getUnidadmedidaNombre());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdunidadmedida(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Unidadmedida Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UnidadmedidaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UnidadmedidaPeer();
        }
     ...
     * If this Unidadmedida is new, it will return
    ...
    public function setProductos(PropelCollection $productos, PropelPDO $con = null)
    {
        ...
        foreach ($productosToDelete as $productoRemoved) {
            $productoRemoved->setUnidadmedida(null);
        }
     ...
     * Otherwise if this Unidadmedida is new, it will return
     * an empty collection; or if this Unidadmedida has previously
     * been saved, it will retrieve related Productos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Unidadmedida.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(UnidadmedidaPeer::DEFAULT_STRING_FORMAT);
    }
