...
/**
 * Base class that represents a row from the 'productocfdi' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseProductocfdi extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProductocfdiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProductocfdiPeer
     */
    ...
    /**
     * The value for the idproductocfdi field.
     * @var        int
     */
    protected $idproductocfdi;
    ...
    /**
     * The value for the productocfdi_nombre field.
     * @var        string
     */
    ...
    /**
     * Get the [idproductocfdi] column value.
     *
     * @return int
     */
    public function getIdproductocfdi()
    {

        return $this->idproductocfdi;
    }
    ...
    /**
     * Get the [productocfdi_nombre] column value.
     *
     * @return string
     */
    public function getProductocfdiNombre()
    {
    ...
    /**
     * Set the value of [idproductocfdi] column.
     *
     * @param  int $v new value
     * @return Productocfdi The current object (for fluent API support)
     */
    public function setIdproductocfdi($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idproductocfdi !== $v) {
            $this->idproductocfdi = $v;
            $this->modifiedColumns[] = ProductocfdiPeer::IDPRODUCTOCFDI;
        }
    ...
    public function setIdempresa($v)
    {
        ...
        if ($this->idempresa !== $v) {
            $this->idempresa = $v;
            $this->modifiedColumns[] = ProductocfdiPeer::IDEMPRESA;
        }
    ...
    public function setIdproducto($v)
    {
        ...
        if ($this->idproducto !== $v) {
            $this->idproducto = $v;
            $this->modifiedColumns[] = ProductocfdiPeer::IDPRODUCTO;
        }
    ...
    /**
     * Set the value of [productocfdi_nombre] column.
     *
     * @param  string $v new value
     * @return Productocfdi The current object (for fluent API support)
     */
    public function setProductocfdiNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->productocfdi_nombre !== $v) {
            $this->productocfdi_nombre = $v;
            $this->modifiedColumns[] = ProductocfdiPeer::PRODUCTOCFDI_NOMBRE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idproductocfdi = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProductocfdiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProductocfdiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductocfdiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductocfdiPeer::IDPRODUCTOCFDI)) {
            $modifiedColumns[':p' . $index++]  = '`idproductocfdi`';
        }
        if ($this->isColumnModified(ProductocfdiPeer::IDEMPRESA)) {
            $modifiedColumns[':p' . $index++]  = '`idempresa`';
        }
        if ($this->isColumnModified(ProductocfdiPeer::IDPRODUCTO)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idproductocfdi`':
                        $stmt->bindValue($identifier, $this->idproductocfdi, PDO::PARAM_INT);
                        break;
                    case '`idempresa`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProductocfdiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProductocfdiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Productocfdi'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Productocfdi'][$this->getPrimaryKey()] = true;
        $keys = ProductocfdiPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdproductocfdi(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdproductocfdi($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductocfdiPeer::IDPRODUCTOCFDI)) $criteria->add(ProductocfdiPeer::IDPRODUCTOCFDI, $this->idproductocfdi);
    ...
    {
        $criteria = new Criteria(ProductocfdiPeer::DATABASE_NAME);
        $criteria->add(ProductocfdiPeer::IDPRODUCTOCFDI, $this->idproductocfdi);
    ...
    /**
     * Generic method to set the primary key (idproductocfdi column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdproductocfdi();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Productocfdi (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdproductocfdi(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Productocfdi Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProductocfdiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProductocfdiPeer();
        }
    ...
    public function getEmpresa(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpresa === null && ($this->idempresa !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpresa->addProductocfdis($this);
             */
        }
    ...
    public function getProducto(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProducto === null && ($this->idproducto !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProducto->addProductocfdis($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProductocfdiPeer::DEFAULT_STRING_FORMAT);
    }
