...
abstract class BaseCuentaporcobrarPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idcuentaporcobrar', 'Idempresa', 'Idsucursal', 'Idusuario', 'CuentaporcobrarCantidad', 'CuentaporcobrarCliente', 'CuentaporcobrarFecha', 'CuentaporcobrarNota', 'CuentaporcobrarAbonado', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcuentaporcobrar', 'idempresa', 'idsucursal', 'idusuario', 'cuentaporcobrarCantidad', 'cuentaporcobrarCliente', 'cuentaporcobrarFecha', 'cuentaporcobrarNota', 'cuentaporcobrarAbonado', ),
        ...
        BasePeer::TYPE_RAW_COLNAME => array ('IDCUENTAPORCOBRAR', 'IDEMPRESA', 'IDSUCURSAL', 'IDUSUARIO', 'CUENTAPORCOBRAR_CANTIDAD', 'CUENTAPORCOBRAR_CLIENTE', 'CUENTAPORCOBRAR_FECHA', 'CUENTAPORCOBRAR_NOTA', 'CUENTAPORCOBRAR_ABONADO', ),
        BasePeer::TYPE_FIELDNAME => array ('idcuentaporcobrar', 'idempresa', 'idsucursal', 'idusuario', 'cuentaporcobrar_cantidad', 'cuentaporcobrar_cliente', 'cuentaporcobrar_fecha', 'cuentaporcobrar_nota', 'cuentaporcobrar_abonado', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idcuentaporcobrar' => 0, 'Idempresa' => 1, 'Idsucursal' => 2, 'Idusuario' => 3, 'CuentaporcobrarCantidad' => 4, 'CuentaporcobrarCliente' => 5, 'CuentaporcobrarFecha' => 6, 'CuentaporcobrarNota' => 7, 'CuentaporcobrarAbonado' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcuentaporcobrar' => 0, 'idempresa' => 1, 'idsucursal' => 2, 'idusuario' => 3, 'cuentaporcobrarCantidad' => 4, 'cuentaporcobrarCliente' => 5, 'cuentaporcobrarFecha' => 6, 'cuentaporcobrarNota' => 7, 'cuentaporcobrarAbonado' => 8, ),
        ...
        BasePeer::TYPE_RAW_COLNAME => array ('IDCUENTAPORCOBRAR' => 0, 'IDEMPRESA' => 1, 'IDSUCURSAL' => 2, 'IDUSUARIO' => 3, 'CUENTAPORCOBRAR_CANTIDAD' => 4, 'CUENTAPORCOBRAR_CLIENTE' => 5, 'CUENTAPORCOBRAR_FECHA' => 6, 'CUENTAPORCOBRAR_NOTA' => 7, 'CUENTAPORCOBRAR_ABONADO' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('idcuentaporcobrar' => 0, 'idempresa' => 1, 'idsucursal' => 2, 'idusuario' => 3, 'cuentaporcobrar_cantidad' => 4, 'cuentaporcobrar_cliente' => 5, 'cuentaporcobrar_fecha' => 6, 'cuentaporcobrar_nota' => 7, 'cuentaporcobrar_abonado' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
