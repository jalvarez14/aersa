...
/**
 * Base class that represents a row from the 'rubroingreso' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseRubroingreso extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RubroingresoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RubroingresoPeer
     */
    ...
    /**
     * The value for the rubroingreso_nombre field.
     * @var        string
     */
    protected $rubroingreso_nombre;

    /**
     * The value for the rubroingreso_descripcion field.
     * @var        string
     */
    protected $rubroingreso_descripcion;
    ...
    /**
     * Get the [rubroingreso_nombre] column value.
     *
     * @return string
     */
    public function getRubroingresoNombre()
    {

        return $this->rubroingreso_nombre;
    }

    /**
     * Get the [rubroingreso_descripcion] column value.
     *
     * @return string
     */
    public function getRubroingresoDescripcion()
    {

        return $this->rubroingreso_descripcion;
    }
     ...
     * @return Rubroingreso The current object (for fluent API support)
     */
    public function setIdrubroingreso($v)
    {
        ...
        if ($this->idrubroingreso !== $v) {
            ...
            $this->modifiedColumns[] = RubroingresoPeer::IDRUBROINGRESO;
        }
    ...
    /**
     * Set the value of [rubroingreso_nombre] column.
     *
     * @param  string $v new value
     * @return Rubroingreso The current object (for fluent API support)
     */
    public function setRubroingresoNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->rubroingreso_nombre !== $v) {
            $this->rubroingreso_nombre = $v;
            $this->modifiedColumns[] = RubroingresoPeer::RUBROINGRESO_NOMBRE;
        }


        return $this;
    } // setRubroingresoNombre()

    /**
     * Set the value of [rubroingreso_descripcion] column.
     *
     * @param  string $v new value
     * @return Rubroingreso The current object (for fluent API support)
     */
    public function setRubroingresoDescripcion($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->rubroingreso_descripcion !== $v) {
            $this->rubroingreso_descripcion = $v;
            $this->modifiedColumns[] = RubroingresoPeer::RUBROINGRESO_DESCRIPCION;
        }


        return $this;
    } // setRubroingresoDescripcion()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idrubroingreso = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->rubroingreso_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->rubroingreso_descripcion = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = RubroingresoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rubroingreso object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RubroingresoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RubroingresoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RubroingresoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RubroingresoPeer::IDRUBROINGRESO)) {
            $modifiedColumns[':p' . $index++]  = '`idrubroingreso`';
        }
        if ($this->isColumnModified(RubroingresoPeer::RUBROINGRESO_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`rubroingreso_nombre`';
        }
        if ($this->isColumnModified(RubroingresoPeer::RUBROINGRESO_DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`rubroingreso_descripcion`';
        }

        $sql = sprintf(
            'INSERT INTO `rubroingreso` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idrubroingreso`':
                        ...
                        break;
                    case '`rubroingreso_nombre`':
                        $stmt->bindValue($identifier, $this->rubroingreso_nombre, PDO::PARAM_STR);
                        break;
                    case '`rubroingreso_descripcion`':
                        $stmt->bindValue($identifier, $this->rubroingreso_descripcion, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RubroingresoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RubroingresoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getRubroingresoNombre();
                break;
            case 2:
                return $this->getRubroingresoDescripcion();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Rubroingreso'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rubroingreso'][$this->getPrimaryKey()] = true;
        $keys = RubroingresoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdrubroingreso(),
            $keys[1] => $this->getRubroingresoNombre(),
            $keys[2] => $this->getRubroingresoDescripcion(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setRubroingresoNombre($value);
                break;
            case 2:
                $this->setRubroingresoDescripcion($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdrubroingreso($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setRubroingresoNombre($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setRubroingresoDescripcion($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RubroingresoPeer::IDRUBROINGRESO)) $criteria->add(RubroingresoPeer::IDRUBROINGRESO, $this->idrubroingreso);
        if ($this->isColumnModified(RubroingresoPeer::RUBROINGRESO_NOMBRE)) $criteria->add(RubroingresoPeer::RUBROINGRESO_NOMBRE, $this->rubroingreso_nombre);
        if ($this->isColumnModified(RubroingresoPeer::RUBROINGRESO_DESCRIPCION)) $criteria->add(RubroingresoPeer::RUBROINGRESO_DESCRIPCION, $this->rubroingreso_descripcion);
    ...
    {
        $criteria = new Criteria(RubroingresoPeer::DATABASE_NAME);
        $criteria->add(RubroingresoPeer::IDRUBROINGRESO, $this->idrubroingreso);
    ...
    /**
     * Generic method to set the primary key (idrubroingreso column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdrubroingreso();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Rubroingreso (or compatible) type.
    ...
    {
        $copyObj->setRubroingresoNombre($this->getRubroingresoNombre());
        $copyObj->setRubroingresoDescripcion($this->getRubroingresoDescripcion());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdrubroingreso(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rubroingreso Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RubroingresoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RubroingresoPeer();
        }
     ...
     * If this Rubroingreso is new, it will return
    ...
    public function setIngresodetalles(PropelCollection $ingresodetalles, PropelPDO $con = null)
    {
        ...
        foreach ($ingresodetallesToDelete as $ingresodetalleRemoved) {
            $ingresodetalleRemoved->setRubroingreso(null);
        }
    ...
    protected function doAddIngresodetalle($ingresodetalle)
    {
        ...
        $ingresodetalle->setRubroingreso($this);
    }
    ...
    public function removeIngresodetalle($ingresodetalle)
    {
        if ($this->getIngresodetalles()->contains($ingresodetalle)) {
            ...
            $ingresodetalle->setRubroingreso(null);
        }
     ...
     * Otherwise if this Rubroingreso is new, it will return
     * an empty collection; or if this Rubroingreso has previously
     * been saved, it will retrieve related Ingresodetalles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rubroingreso.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function clear()
    {
        ...
        $this->rubroingreso_nombre = null;
        $this->rubroingreso_descripcion = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(RubroingresoPeer::DEFAULT_STRING_FORMAT);
    }
