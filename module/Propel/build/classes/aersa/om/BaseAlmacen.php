...
abstract class BaseAlmacen extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->almacen_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->almacen_encargado = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aSucursal !== null && $this->idalmacen !== $this->aSucursal->getIdsucursal()) {
            $this->aSucursal = null;
        }
    } // ensureConsistency
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getAlmacenNombre(),
            $keys[2] => $this->getAlmacenEncargado(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setAlmacenNombre($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setAlmacenEncargado($arr[$keys[2]]);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            $relObj = $this->getSucursal();
            if ($relObj) {
                $copyObj->setSucursal($relObj->copy($deepCopy));
            }
    ...
    public function setSucursal(Sucursal $v = null)
    {
        if ($v === null) {
            ...
            $this->setIdalmacen($v->getIdsucursal());
        }
    ...
    {
        if ($this->aSucursal === null && ($this->idalmacen !== null) && $doQuery) {
            $this->aSucursal = SucursalQuery::create()->findPk($this->idalmacen, $con);
            // Because this foreign key represents a one-to-one relationship, we will create a bi-directional association.
            $this->aSucursal->setAlmacen($this);
        }
