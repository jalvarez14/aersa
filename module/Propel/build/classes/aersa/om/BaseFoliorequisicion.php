...
/**
 * Base class that represents a row from the 'foliorequisicion' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseFoliorequisicion extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'FoliorequisicionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FoliorequisicionPeer
     */
    ...
    /**
     * The value for the idfoliorequisicion field.
     * @var        int
     */
    protected $idfoliorequisicion;
    ...
    /**
     * Get the [idfoliorequisicion] column value.
     *
     * @return int
     */
    public function getIdfoliorequisicion()
    {

        return $this->idfoliorequisicion;
    }
    ...
    /**
     * Set the value of [idfoliorequisicion] column.
     *
     * @param  int $v new value
     * @return Foliorequisicion The current object (for fluent API support)
     */
    public function setIdfoliorequisicion($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idfoliorequisicion !== $v) {
            $this->idfoliorequisicion = $v;
            $this->modifiedColumns[] = FoliorequisicionPeer::IDFOLIOREQUISICION;
        }


        return $this;
    } // setIdfoliorequisicion()
    ...
    public function setFolio($v)
    {
        ...
        if ($this->folio !== $v) {
            $this->folio = $v;
            $this->modifiedColumns[] = FoliorequisicionPeer::FOLIO;
        }
    ...
    public function setIdempresa($v)
    {
        ...
        if ($this->idempresa !== $v) {
            $this->idempresa = $v;
            $this->modifiedColumns[] = FoliorequisicionPeer::IDEMPRESA;
        }
    ...
    public function setIdsucursal($v)
    {
        ...
        if ($this->idsucursal !== $v) {
            $this->idsucursal = $v;
            $this->modifiedColumns[] = FoliorequisicionPeer::IDSUCURSAL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idfoliorequisicion = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 4; // 4 = FoliorequisicionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Foliorequisicion object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FoliorequisicionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FoliorequisicionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FoliorequisicionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = FoliorequisicionPeer::IDFOLIOREQUISICION;
        if (null !== $this->idfoliorequisicion) {
        ...
        if ($this->isColumnModified(FoliorequisicionPeer::IDFOLIOREQUISICION)) {
            $modifiedColumns[':p' . $index++]  = '`idfoliorequisicion`';
        }
        if ($this->isColumnModified(FoliorequisicionPeer::FOLIO)) {
            $modifiedColumns[':p' . $index++]  = '`folio`';
        }
        if ($this->isColumnModified(FoliorequisicionPeer::IDEMPRESA)) {
            $modifiedColumns[':p' . $index++]  = '`idempresa`';
        }
        if ($this->isColumnModified(FoliorequisicionPeer::IDSUCURSAL)) {
            $modifiedColumns[':p' . $index++]  = '`idsucursal`';
        }

        $sql = sprintf(
            'INSERT INTO `foliorequisicion` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idfoliorequisicion`':
                        $stmt->bindValue($identifier, $this->idfoliorequisicion, PDO::PARAM_INT);
                        break;
                    case '`folio`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FoliorequisicionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FoliorequisicionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdfoliorequisicion();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Foliorequisicion'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Foliorequisicion'][$this->getPrimaryKey()] = true;
        $keys = FoliorequisicionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdfoliorequisicion(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdfoliorequisicion($value);
                break;
            case 1:
                $this->setFolio($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdfoliorequisicion($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FoliorequisicionPeer::IDFOLIOREQUISICION)) $criteria->add(FoliorequisicionPeer::IDFOLIOREQUISICION, $this->idfoliorequisicion);
        if ($this->isColumnModified(FoliorequisicionPeer::FOLIO)) $criteria->add(FoliorequisicionPeer::FOLIO, $this->folio);
        if ($this->isColumnModified(FoliorequisicionPeer::IDEMPRESA)) $criteria->add(FoliorequisicionPeer::IDEMPRESA, $this->idempresa);
        if ($this->isColumnModified(FoliorequisicionPeer::IDSUCURSAL)) $criteria->add(FoliorequisicionPeer::IDSUCURSAL, $this->idsucursal);
    ...
    {
        $criteria = new Criteria(FoliorequisicionPeer::DATABASE_NAME);
        $criteria->add(FoliorequisicionPeer::IDFOLIOREQUISICION, $this->idfoliorequisicion);
    ...
    /**
     * Generic method to set the primary key (idfoliorequisicion column).
     *
    ...
    {
        $this->setIdfoliorequisicion($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdfoliorequisicion();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Foliorequisicion (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdfoliorequisicion(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Foliorequisicion Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FoliorequisicionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FoliorequisicionPeer();
        }
    ...
    public function getEmpresa(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpresa === null && ($this->idempresa !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpresa->addFoliorequisicions($this);
             */
        }
    ...
    public function getSucursal(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSucursal === null && ($this->idsucursal !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSucursal->addFoliorequisicions($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FoliorequisicionPeer::DEFAULT_STRING_FORMAT);
    }
