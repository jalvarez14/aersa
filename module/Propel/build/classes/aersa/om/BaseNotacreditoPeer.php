...
abstract class BaseNotacreditoPeer
{
    ...
    const IDPROVEEDOR = 'notacredito.idproveedor';
    ...
    /** the column name for the notacredito_fechanotacredito field */
    const NOTACREDITO_FECHANOTACREDITO = 'notacredito.notacredito_fechanotacredito';
    ...
    /** the column name for the notacredito_subtotal field */
    const NOTACREDITO_SUBTOTAL = 'notacredito.notacredito_subtotal';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idnotacredito', 'Idempresa', 'Idsucursal', 'Idproveedor', 'Idusuario', 'Idauditor', 'Idalmacen', 'NotacreditoFolio', 'NotacreditoRevisada', 'NotacreditoFactura', 'NotacreditoFechacreacion', 'NotacreditoFechanotacredito', 'NotacreditoIeps', 'NotacreditoIva', 'NotacreditoTotal', 'NotacreditoSubtotal', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idnotacredito', 'idempresa', 'idsucursal', 'idproveedor', 'idusuario', 'idauditor', 'idalmacen', 'notacreditoFolio', 'notacreditoRevisada', 'notacreditoFactura', 'notacreditoFechacreacion', 'notacreditoFechanotacredito', 'notacreditoIeps', 'notacreditoIva', 'notacreditoTotal', 'notacreditoSubtotal', ),
        BasePeer::TYPE_COLNAME => array (NotacreditoPeer::IDNOTACREDITO, NotacreditoPeer::IDEMPRESA, NotacreditoPeer::IDSUCURSAL, NotacreditoPeer::IDPROVEEDOR, NotacreditoPeer::IDUSUARIO, NotacreditoPeer::IDAUDITOR, NotacreditoPeer::IDALMACEN, NotacreditoPeer::NOTACREDITO_FOLIO, NotacreditoPeer::NOTACREDITO_REVISADA, NotacreditoPeer::NOTACREDITO_FACTURA, NotacreditoPeer::NOTACREDITO_FECHACREACION, NotacreditoPeer::NOTACREDITO_FECHANOTACREDITO, NotacreditoPeer::NOTACREDITO_IEPS, NotacreditoPeer::NOTACREDITO_IVA, NotacreditoPeer::NOTACREDITO_TOTAL, NotacreditoPeer::NOTACREDITO_SUBTOTAL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDNOTACREDITO', 'IDEMPRESA', 'IDSUCURSAL', 'IDPROVEEDOR', 'IDUSUARIO', 'IDAUDITOR', 'IDALMACEN', 'NOTACREDITO_FOLIO', 'NOTACREDITO_REVISADA', 'NOTACREDITO_FACTURA', 'NOTACREDITO_FECHACREACION', 'NOTACREDITO_FECHANOTACREDITO', 'NOTACREDITO_IEPS', 'NOTACREDITO_IVA', 'NOTACREDITO_TOTAL', 'NOTACREDITO_SUBTOTAL', ),
        BasePeer::TYPE_FIELDNAME => array ('idnotacredito', 'idempresa', 'idsucursal', 'idproveedor', 'idusuario', 'idauditor', 'idalmacen', 'notacredito_folio', 'notacredito_revisada', 'notacredito_factura', 'notacredito_fechacreacion', 'notacredito_fechanotacredito', 'notacredito_ieps', 'notacredito_iva', 'notacredito_total', 'notacredito_subtotal', ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NotacreditoPeer::IDPROVEEDOR);
            ...
            $criteria->addSelectColumn(NotacreditoPeer::NOTACREDITO_FECHANOTACREDITO);
            ...
            $criteria->addSelectColumn($alias . '.notacredito_fechanotacredito');
    ...
    public static function doCountJoinProveedor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(NotacreditoPeer::IDPROVEEDOR, ProveedorPeer::IDPROVEEDOR, $join_behavior);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key5 !== null) {
                ...
                // Add the $obj1 (Notacredito) to the collection in $obj5 (Proveedor)
            ...
            if ($key6 !== null) {
                ...
                // Add the $obj1 (Notacredito) to the collection in $obj6 (Sucursal)
                $obj6->addNotacredito($obj1);
            } // if joined row not null
            ...
            if ($key7 !== null) {
                ...
                // Add the $obj1 (Notacredito) to the collection in $obj7 (Usuario)
                $obj7->addNotacreditoRelatedByIdusuario($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptAlmacen(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = NotacreditoPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Notacredito) to the collection in $obj4 (Proveedor)
                $obj4->addNotacredito($obj1);
