...
abstract class BaseInventariomesdetallePeer
{
    ...
    /** the column name for the inventariomesdetalle_reajuste field */
    const INVENTARIOMESDETALLE_REAJUSTE = 'inventariomesdetalle.inventariomesdetalle_reajuste';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(InventariomesdetallePeer::INVENTARIOMESDETALLE_REAJUSTE);
            ...
            $criteria->addSelectColumn($alias . '.inventariomesdetalle_reajuste');
