...
/**
 * Base class that represents a row from the 'devolucionnota' table.
 *
 *
 *
 * @package    propel.generator.aersa.om
 */
abstract class BaseDevolucionnota extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DevolucionnotaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DevolucionnotaPeer
     */
    ...
    /**
     * The value for the iddevolucionnota field.
     * @var        int
     */
    protected $iddevolucionnota;
    ...
    /**
     * The value for the devolucionnota_nota field.
     * @var        string
     */
    ...
    /**
     * Get the [iddevolucionnota] column value.
     *
     * @return int
     */
    public function getIddevolucionnota()
    {

        return $this->iddevolucionnota;
    }
    ...
    /**
     * Get the [devolucionnota_nota] column value.
     *
     * @return string
     */
    public function getDevolucionnotaNota()
    {
    ...
    /**
     * Set the value of [iddevolucionnota] column.
     *
     * @param  int $v new value
     * @return Devolucionnota The current object (for fluent API support)
     */
    public function setIddevolucionnota($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->iddevolucionnota !== $v) {
            $this->iddevolucionnota = $v;
            $this->modifiedColumns[] = DevolucionnotaPeer::IDDEVOLUCIONNOTA;
        }
    ...
    public function setIddevolucion($v)
    {
        ...
        if ($this->iddevolucion !== $v) {
            $this->iddevolucion = $v;
            $this->modifiedColumns[] = DevolucionnotaPeer::IDDEVOLUCION;
        }
    ...
    public function setIdusuario($v)
    {
        ...
        if ($this->idusuario !== $v) {
            $this->idusuario = $v;
            $this->modifiedColumns[] = DevolucionnotaPeer::IDUSUARIO;
        }
    ...
    /**
     * Set the value of [devolucionnota_nota] column.
     *
     * @param  string $v new value
     * @return Devolucionnota The current object (for fluent API support)
     */
    public function setDevolucionnotaNota($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->devolucionnota_nota !== $v) {
            $this->devolucionnota_nota = $v;
            $this->modifiedColumns[] = DevolucionnotaPeer::DEVOLUCIONNOTA_NOTA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->iddevolucionnota = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DevolucionnotaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DevolucionnotaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DevolucionnotaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DevolucionnotaPeer::IDDEVOLUCIONNOTA)) {
            $modifiedColumns[':p' . $index++]  = '`iddevolucionnota`';
        }
        if ($this->isColumnModified(DevolucionnotaPeer::IDDEVOLUCION)) {
            $modifiedColumns[':p' . $index++]  = '`iddevolucion`';
        }
        if ($this->isColumnModified(DevolucionnotaPeer::IDUSUARIO)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`iddevolucionnota`':
                        $stmt->bindValue($identifier, $this->iddevolucionnota, PDO::PARAM_INT);
                        break;
                    case '`iddevolucion`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DevolucionnotaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DevolucionnotaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIddevolucionnota();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Devolucionnota'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Devolucionnota'][$this->getPrimaryKey()] = true;
        $keys = DevolucionnotaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIddevolucionnota(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIddevolucionnota($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIddevolucionnota($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DevolucionnotaPeer::IDDEVOLUCIONNOTA)) $criteria->add(DevolucionnotaPeer::IDDEVOLUCIONNOTA, $this->iddevolucionnota);
    ...
    {
        $criteria = new Criteria(DevolucionnotaPeer::DATABASE_NAME);
        $criteria->add(DevolucionnotaPeer::IDDEVOLUCIONNOTA, $this->iddevolucionnota);
    ...
    /**
     * Generic method to set the primary key (iddevolucionnota column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIddevolucionnota();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Devolucionnota (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIddevolucionnota(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Devolucionnota Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DevolucionnotaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DevolucionnotaPeer();
        }
    ...
    public function getDevolucion(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDevolucion === null && ($this->iddevolucion !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDevolucion->addDevolucionnotas($this);
             */
        }
    ...
    public function getUsuario(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUsuario === null && ($this->idusuario !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUsuario->addDevolucionnotas($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DevolucionnotaPeer::DEFAULT_STRING_FORMAT);
    }
