...
class InventariomesTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('idempleadoempresa', 'Idempleadoempresa', 'FLOAT', true, null, null);
        ...
        $this->addForeignKey('idusuario', 'Idusuario', 'INTEGER', 'usuario', 'idusuario', false, null, null);
        // validators
    } // initialize()
    ...
    {
        $this->addRelation('UsuarioRelatedByIdauditor', 'Usuario', RelationMap::MANY_TO_ONE, array('idauditor' => 'idusuario', ), null, null);
        $this->addRelation('UsuarioRelatedByIdusuario', 'Usuario', RelationMap::MANY_TO_ONE, array('idusuario' => 'idusuario', ), null, null);
