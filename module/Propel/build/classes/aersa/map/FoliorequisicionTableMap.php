...
/**
 * This class defines the structure of the 'foliorequisicion' table.
 *
 *
 *
 ...
 */
class FoliorequisicionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'aersa.map.FoliorequisicionTableMap';
    ...
    {
        // attributes
        $this->setName('foliorequisicion');
        $this->setPhpName('Foliorequisicion');
        $this->setClassname('Foliorequisicion');
        $this->setPackage('aersa');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('idfoliorequisicion', 'Idfoliorequisicion', 'INTEGER', true, null, null);
