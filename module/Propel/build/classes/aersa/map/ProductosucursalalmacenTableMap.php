...
/**
 * This class defines the structure of the 'productosucursalalmacen' table.
 *
 *
 *
 ...
 */
class ProductosucursalalmacenTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'aersa.map.ProductosucursalalmacenTableMap';
    ...
    {
        // attributes
        $this->setName('productosucursalalmacen');
        $this->setPhpName('Productosucursalalmacen');
        $this->setClassname('Productosucursalalmacen');
        $this->setPackage('aersa');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('idproductosucursalalmacen', 'Idproductosucursalalmacen', 'INTEGER', true, null, null);
...
} // ProductosucursalalmacenTableMap
