...
/**
 * This class defines the structure of the 'devolucionnota' table.
 *
 *
 *
 ...
 */
class DevolucionnotaTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'aersa.map.DevolucionnotaTableMap';
    ...
    {
        // attributes
        $this->setName('devolucionnota');
        $this->setPhpName('Devolucionnota');
        $this->setClassname('Devolucionnota');
        $this->setPackage('aersa');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('iddevolucionnota', 'Iddevolucionnota', 'INTEGER', true, null, null);
