...
/**
 * This class defines the structure of the 'usuarioalmacen' table.
 *
 *
 *
 ...
 */
class UsuarioalmacenTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'aersa.map.UsuarioalmacenTableMap';
    ...
    {
        // attributes
        $this->setName('usuarioalmacen');
        $this->setPhpName('Usuarioalmacen');
        $this->setClassname('Usuarioalmacen');
        $this->setPackage('aersa');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('idusuarioalmacen', 'Idusuarioalmacen', 'INTEGER', true, null, null);
