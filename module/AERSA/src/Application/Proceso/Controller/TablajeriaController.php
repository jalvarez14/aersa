...
class TablajeriaController extends AbstractActionController {
     ...
     public function getalmacenesbyinventarioAction(){
        ...
        if($request->isPost()){
            ...
            $almacenes_array = \AlmacenQuery::create()->filterByAlmacenNombre('Servicio',  \Criteria::NOT_EQUAL)->filterByAlmacenNombre('Consignación',  \Criteria::NOT_EQUAL)->filterByAlmacenNombre('Bonificados',  \Criteria::NOT_EQUAL)->filterByAlmacenNombre('Barra',  \Criteria::NOT_EQUAL)->filterByAlmacenNombre('Créditos al costo',  \Criteria::NOT_EQUAL)->filterByAlmacenEstatus(1)->select(array('Idalmacen'))->filterByIdsucursal($session['idsucursal'])->find()->toArray();
