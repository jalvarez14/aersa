    ...
    public function indexAction() {
        ...
        if ($request->isPost()) {
            ...
            if (isset($post_data['generar_excel']) || isset($post_data['generar_pdf'])) {
                ...
                array_push($reporte, "<tr><td>Inventario inicial</td><td>".number_format($invIniAlimentos,2)."</td><td></td><td>".number_format($invIniBebidas,2)."</td><td></td><td>$invIniConsolidado</td><td></td></tr>");
                ...
                array_push($reporte, "<tr><td>Creditos al costo</td><td>".number_format($creditosCostAlimentos,2)."</td><td></td><td>".number_format($creditosCostBebidas,2)."</td><td></td><td>".number_format($creditosCostConsolidado,2)."</td><td></td></tr>");
                ...
                array_push($reporte, "<tr><td>Cortesias</td><td>".number_format($cortesiasAlimentos,2)."</td><td>".number_format($porcCortesiasAlimentos,2)." %</td><td>".number_format($cortesiasBebidas,2)."</td><td>".number_format($porcCortesiasBebidas,2)." %</td><td></td><td></td></tr>");
